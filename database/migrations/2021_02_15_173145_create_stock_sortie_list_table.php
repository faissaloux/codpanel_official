...
class CreateStockSortieListTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stock_sortie_list', function (Blueprint $table) {
            ...
            $table->string('sortie_list_id', 255)->nullable()->default(null);
    ...
    {
        Schema::dropIfExists('stock_sortie_list');
    }
}
