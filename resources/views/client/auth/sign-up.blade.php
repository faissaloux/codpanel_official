                                ...
                                <div class="col-12">
                                    <div class="card login_page border-0" style="z-index: 1">
                                        <div class="card-body p-0">
                                            ...
                                            <form action="{{ route('client.store') }}" class="login-form mt-4" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" class="custom-control-input" name="AcceptTerms" id="customCheck1">
                                                    ...
                                                    <div class="col-md-12">
<<<<<<< HEAD:resources/views/singup.blade.php
...
>>>>>>> 0753fc91a285b3ccc198700118acdc378ab65eab:resources/views/client/auth/sign-up.blade.php

                                                    <div class="mx-auto">
                                                        <p class="mb-0 mt-3">
                                                            <small class="text-dark mr-2">Already have an account ?</small>
                                                            <a href="" class="text-dark font-weight-bold">Log in</a>
                                                        </p>
                                                    </div>
                                                </div><!--end row-->
                                            </form>
                    ...
                    <div class="col-lg-8 offset-lg-4 padding-less img order-1" style="background-image:url('{{ asset('images/user/02.jpg') }}')" data-jarallax='{"speed": 0.5}'></div><!-- end col -->
                </div><!--end row-->
