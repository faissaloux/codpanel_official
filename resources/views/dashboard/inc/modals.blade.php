                    ...
                    <div class="d-flex flex-column">
                        <div class="form-group d-flex align-items-center">
                            ...
                            <select class="form-control col" name="product">
                                ...
                                <option value="133">الشريط المرن</option>
                                <option value="135">test prduit</option>
                            </select>
                        </div>
                        <div class="form-group d-flex align-items-center">
...
<div    class="modal fade"
    ...
    <div    class="modal-dialog modal-lg modal-dialog-centered"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column">
                <form action="{{ route('dashboard.stock.save.retour') }}" method="post">
                    @csrf
                    <div class="d-flex flex-column">
                        <div class="form-group">
                            ...
                            <div class="d-flex clonedSortie">
                                ...
                                <div class="form-group col pl-0">
                                    <select id="citiesList" class="form-control" name="cities[]" placeholder="produit">
                                        ...
                                        <option value="171">Tan-Tan</option>
                                        <option value="172">Kelaat-M'Gouna</option>
                                        <option value="173">Boumalne-Dades</option>
                                        <option value="174">Skoura</option>
                                    </select>
                                </div>
                                <div class="col-1">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <p class="p-0">
                            <button type="submit" class="btn btn-success btn-block">حفظ السلعة المرجعة</button>
                        </p>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-column">
                <form action="" method="">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <p class="p-0">
                            <a href="#" type="button" class="btn btn-success btn-block">إضافة المخزون</a>
                        </p>
                    </div>
                </form>
            </div>
