                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        ...
                        <ul class="list-unstyled footer-list mt-4">
                            ...
                            <li><a href="{{route('faq')}}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Freqs</a></li>
                             <li><a href="{{route('contact')}}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Contact us</a></li>
                             
                            <li><a href="{{route('singin')}}" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Login</a></li>
                        </ul>
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="text-sm-left">
                            <p class="mb-0">© 2020 Imra Shop <i class=" "></i>  </p>
                        </div>
                    </div><!--end col-->
