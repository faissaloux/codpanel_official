    ...
    <div class="page-inner mt-4">
        ...
        <div class="card-body pd-0 tx-center load-table">
            ...
            <table class="table table-primary table-hover">
                <thead>
                    <tr>
                        <th scope="col" class="active"><input id="checkAll" type="checkbox" class="show-actions-menu"/></th>
                ...
                <tbody class="table-body-listing">
                    @foreach($lists['lists'] as $list)
                        <tr class="{{ 'list_'.$list->id }}" >
                            <th scope="row" class="active"><input type="checkbox"  data-item="{{ $list->id }}" class="hoverRow check"/></th>
