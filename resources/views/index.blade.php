                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-4">الخصائص و المزايا </h4>
                            <p class="text-muted para-desc mb-0 mx-auto">     نوفر لك خدمات  لإدارة المبيعات بخصائص و مزايا متعددة  <span class="text-primary font-weight-bold">  Codpanel  </span>  ابدأ العمل   مع     </p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="text" class="form-control pl-5" placeholder="الاسم" name="name" required="">
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="email" class="form-control pl-5" placeholder="البريد الالكتروني " name="email" required="">
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group position-relative">
                                                    ...
                                                    <input type="password" class="form-control pl-5" placeholder="كلمة المرور " required="">
                                                </div>
                                            </div><!--end col-->

                                            <div class="col-lg-12 mt-2 mb-0">
                                              <a href="{{route('singup')}}"> <button  class="btn btn-primary btn-block">إشترك الأن </button></a> 
                                            </div><!--end col-->
                                        </div>
                                    </form>                                    
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title mb-4 pb-2">
                            ...
                            <p class="text-muted para-desc mx-auto mb-0">  يمكن أن توفر كل ما تحتاجه لزيادة و إدارة
مبيعاتك بالدفع عند الإستلام <span class="text-primary font-weight-bold"> Codpanel </span>  ابدأ العمل مع</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-md-4 col-12">
                        <div class="features mt-5">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2"> التجارة الالكترونية المحلية</h4>
                                <p class="text-muted mb-0"> 
تعتبر التجارة الالكترونية المحلية نقطة انطلاق أي مبتدئ في مجال التجارة الالكترونية, لأنها تتميز بسهولة البدء فيها وتحقيق مبيعات منذ الأسابيع الأولى للمتجر الالكتروني.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2"> التجارة الإلكترونية بالدفع عند الاستلام (Cash On Delivery)</h4>
                                <p class="text-muted mb-0">  الطريقة التقليدية, والأكثر نجاعة هي طريقة الدفع عند الاستلام, والتي تسمى Cash on delivery والمعروفة اختصارا ب COD. تعتمد هذه الطريقة على دفع الزبون مقابل طلبه أثناء تسليم الطلبية, يدا بيد
</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">  بيع المنتجات عن طريق متجرك الالكتروني الخاص </h4>
                                <p class="text-muted mb-0"> إنشاء متجرك الالكتروني الخاص يعطيك الحرية الكاملة في شكل ومحتوى الموقع.

المتجر الالكتروني الاحترافي يساعدك في ادارة عملك بشكل متكامل: استقبال الطلبات, تتبعها, ادارة فريق العمل والكثير من الأمور الأخرى</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">التعامل مع طلبات الزبناء</h4>
                                <p class="text-muted mb-0"> بعد التوصل بطلب الزبون, يبدأ الجد والعمل الهدف الأساسي لكل تاجر هو الحصول على الزبناء, لكن مراحل التعامل مع طلبات الزبناء في التجارة الالكترونية لها نظام خاص 
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">إرسال الطلب عن طريق الموزعين</h4>
                                <p class="text-muted mb-0">يمكن إرسال الطلبيات عبر موزعين مختصين, والذين يتميزون بالسرعة كما أنها تشمل أغلب مدن   القريبة والبعيدة  .
 </p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 col-12 mt-5">
                        <div class="features">
                            ...
                            <div class="content mt-4">
                                <h4 class="title-2">إدارة فريق عمل أكبر</h4>
                                <p class="text-muted mb-0"> كلما كان عدد المبيعات أكبر, تصبح عملية التسيير أصعب وهنا يبدأ دورك الحقيقي كمدير للمشروع.ادارة فريق العمل تحتاج مهارات وخبرة مهمة لتجد أسلوب العمل الذي يناسبك ويناسب فريقك.</p>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
...
وبالتالي لا توجد نسبة محددة للرسوم التي تفرضها شركات الشحن على خدمة تحصيل الأموال التابعة لنظام الدفع عند الاستلام، وإنما الأمر يتعلق بالاتفاق مع شركة الشحن التي بالفعل تفرض رسوم إضافية غير رسوم شحن المنتج.</p>
                ...
                <div class="row mt-md-5 pt-md-3 mt-4 pt-2 mt-sm-0 pt-sm-0 justify-content-center">
                    <div class="col-12 text-center">
                        <div class="section-title">
                            <h4 class="title mb-4">لديك سؤال ؟ ابقى على تواصل!</h4>
