<div class="modal-cont modal-top mb-3 float-right">
    ...
    <div class="col-md-12 col-lg-12 text-center chnage_statue" data-id="{{ $list->id }}" data-link="{{ route('provider.statue' , ['id' => $list->id ]) }}">
        ...
        <a href="javascript:;" data-type="delivred" class="btn btn-primary rounded ">تم الشحن</a>
    </div>
</div>