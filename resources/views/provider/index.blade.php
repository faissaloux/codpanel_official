...
<body dir="rtl" class="providers-listing-page" data-auth-id="{{ $auth->id }}" data-auth-type="{{ System::auth_type() }}" data-limit="20" data-product="" data-employee="" data-provider=""  data-search="" data-city="" data-orderby="" data-from="" data-to="" data-handler="provider" data-type="">
                            ...
                            <li class="list-inline-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-profile">
                                    <div class="user-profile-area d-flex flex-column tx-right">
                                        <a href="{{route('provider.profile', ['id' => $auth->id ])}}" class="dropdown-item m-auto">
                ...
                <ul class="nav nav-tabs type-list" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a  class="nav-link status-click"
                            ...
                            <span class="quantity col">{{$result->delivred}}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a  class="nav-link status-click"
